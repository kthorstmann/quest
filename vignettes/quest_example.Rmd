...
### this will only be one function. 

## then another function that makes the measurement models for lavaan.
  ## this will be included in the final function
## returns the final data frame with factor scores.
